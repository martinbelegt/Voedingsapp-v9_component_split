export const knowledgeCategories = [
  {
    ...
    name: "Voeding",
    sources: [
      { id: "voedingscentrum", name: "Voedingscentrum", specialization: "Voeding en gezonde keuzes", description: "Praktische informatie over gezond, veilig en duurzaam eten.", uses: ["voedingswaarden", "algemene voedingsadviezen", "gezonde voeding"], reliability: "Nederlands voedingsvoorlichtingscentrum", website: "https://www.voedingscentrum.nl/" },
  ...
  },
  {
    ...
    name: "Supplementen",
    sources: [
      { id: "examine", name: "Examine.com", specialization: "Supplementen", description: "Samenvattingen van wetenschappelijk onderzoek naar supplementen, gefinancierd via betaalde abonnementen en producten.", uses: ["doseringen", "werkzaamheid", "veiligheid", "bewijsniveau"], reliability: "Commercieel kennisplatform; stelt zelf advertentie-, sponsor- en branchevrij te werken", website: "https://examine.com/" },
      { id: "ais", name: "Australian Institute of Sport", specialization: "Sportvoeding", description: "Evidence-based classificatie van supplementen voor sporters en prestaties.", uses: ["sportvoeding", "prestatiebevorderende supplementen", "classificatie"], reliability: "Australisch nationaal instituut voor topsport", website: "https://www.ausport.gov.au/ais/nutrition/supplements" },
  ...
  },
  {
    ...
    name: "Diabetes",
    sources: [
      { id: "dvn", name: "Diabetesvereniging Nederland", specialization: "Leven met diabetes", description: "Nederlandse patiëntenvereniging met praktische informatie en belangenbehartiging.", uses: ["diabeteszorg", "glucose", "leefstijl"], reliability: "Nederlandse vereniging van en voor mensen met diabetes", website: "https://www.dvn.nl/" },
      { id: "ada", name: "American Diabetes Association", specialization: "Diabeteszorg", description: "Amerikaanse zorgstandaarden en publieksinformatie over diabetes.", uses: ["diabeteszorg", "glucose", "leefstijl", "behandeling"], reliability: "Amerikaanse non-profit gezondheidsorganisatie", website: "https://diabetes.org/" },
  ...
  },
  {
    ...
    name: "Gezondheid",
    sources: [
      { id: "thuisarts", name: "Thuisarts.nl", specialization: "Medische publieksinformatie", description: "Toegankelijke informatie over klachten, gezondheid en contact met de huisarts.", uses: ["algemene gezondheid", "preventie", "leefstijl"], reliability: "Van het NHG, gemaakt met medisch specialisten en Patiëntenfederatie Nederland", website: "https://www.thuisarts.nl/" },
  ...
  },
  {
    ...
    sources: [
      ...
      { id: "scholar", name: "Google Scholar", specialization: "Wetenschappelijke literatuur", description: "Commerciële zoekdienst van Google voor artikelen, proefschriften, boeken en citaties.", uses: ["aanvullend literatuuronderzoek"], reliability: "Zoekindex, geen inhoudelijke kwaliteitsbeoordeling; gevonden bronnen worden afzonderlijk beoordeeld", website: "https://scholar.google.com/" },
    ],
  },
];
