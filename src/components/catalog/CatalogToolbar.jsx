...
export default function CatalogToolbar({
  ...
  searchPlaceholder,
  showSupplementSwitch = false,
}) {
  const categoryButtonLabel = showSupplementSwitch && activeView === "categories" ? "Supplementen" : "Categorieën";
  const categoryButtonAction = showSupplementSwitch && activeView === "categories" ? onShowProducts : onShowCategories;
  return (
    <div className="catalog-toolbar" role="toolbar" aria-label="Catalogusbediening">
      ...
      <button type="button" className={activeView === "categories" ? "is-active" : ""} aria-pressed={activeView === "categories"} onClick={categoryButtonAction}>{categoryButtonLabel}</button>
      <label>
